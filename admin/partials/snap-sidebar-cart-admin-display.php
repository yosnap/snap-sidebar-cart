            ...
            <div id="general-settings" class="snap-sidebar-cart-settings-section">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="snap_sidebar_cart_options[container_selector]" name="snap_sidebar_cart_options[container_selector]" value="<?php echo esc_attr($this->options['container_selector']); ?>" class="regular-text" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="snap_sidebar_cart_options[activation_selectors]" name="snap_sidebar_cart_options[activation_selectors]" value="<?php echo esc_attr($this->options['activation_selectors']); ?>" class="regular-text" />
